...
export async function generateMetadata({
    ...
    const t = (await getDictionary(locale)).customers;
    return {
        title: t.metaTitle,
        description: t.metaDescription,
        alternates: buildAlternates(locale, '/customers'),
        openGraph: {
...
export default async function CustomersPage({ params }: { params: Promise<{ lang: string }> }) {
    ...
    const breadcrumbLd = {
        ...
        itemListElement: [
            ...
            { '@type': 'ListItem', position: 2, name: t.breadcrumb, item: `${SITE_URL}/${locale}/customers` },
        ],
    };
