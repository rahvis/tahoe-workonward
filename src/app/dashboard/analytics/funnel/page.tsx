...
import { AnalyticsTabs, FunnelChart, RangeTabs, RollupFreshness, formatDayLabel } from '../_components/charts';
...
function FunnelContent() {
    ...
    useEffect(() => {
        ...
        setTab(isFunnelTab(nextTab) ? nextTab : 'funnel');
    }, [searchParams]);
        ...
        <section className={`${styles.page} ${styles.animateIn}`}>
            <div className={styles.header}>
                <div>
                    ...
                    <h1 className={styles.title}>Workflow funnel</h1>
                </div>
